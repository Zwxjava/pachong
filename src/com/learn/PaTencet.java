...
public class PaTencet {
	...
	public static void login() throws Exception {
        ...
        // 获取td，可以 通过查看页面源码代码得知
        String type ="";
        List<Element> elements= d1.select("#J-filter");
        /*Element eone =elements.get(0).getAllElements().get(1);
    	System.out.println("ddd"+eone);
        System.out.println();
        type = eone.attr("data-type"); 
		System.out.println(type);*/
        
        System.out.println(elements.get(0).getAllElements().size());
        for (int i = 2; i<elements.get(0).getAllElements().size();i++) {
        	Element eone =elements.get(0).getAllElements().get(i);
			 type = eone.attr("data-type");
	        ...
	        for (Element e : et.get(0).getAllElements()) {
	            ...
	            if (e.attr("data-type").equals(type)) {
	            	System.out.println(e.attr("data-type").equals(type));
	              ...
	              String neednum ="请看详情";
	              String company ="阿里巴巴";
	              String jobtype =eone.select("a[data-type='"+type+"']").text();
	              try {
